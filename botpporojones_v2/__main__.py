...
from botpporojones_v2 import __version__
...
app = typer.Typer(
    ...
    help="In which I rework my old discord bot to be better, faster, more efficient, and have better commands.",
...
def version_callback(value: bool):
    ...
    if value:
        console.print(
            f"[yellow]botpporojones_v2[/] version: [bold blue]{__version__}[/]"
        )
        raise typer.Exit()
...
def main(
    ...
    version: bool = typer.Option(
        ...
        is_eager=True,
        help="Prints the version of the botpporojones_v2 package.",
    ),
):
